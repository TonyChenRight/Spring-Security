...
import com.huobi.security.app.AppSecretException;
...
public class AppSignUpUtils {
    ...
    public void doPostSiginUp(WebRequest request,String userId){
    ...
    private String getKey(WebRequest request) {
        ...
        return "huobi:security:social.connect."+deviceId;
    }
}
